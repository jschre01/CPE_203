...
public class Detective extends Entity_Action {

    private int goldNum;


    public Detective(Point position,
    ...
    public static Detective createDetective(Point p, int actionPeriod, List<PImage> images)
    {
        return new Detective(p, images.stream().map(shrinkImage).collect(Collectors.toList()), actionPeriod);
    }
}
